...
from backend.routers import products, access, catalog, webhooks, admin, contracts
...
app.include_router(contracts.router, prefix="/api/products/{product_id}/contracts", tags=["contracts"])
